  ...
  >
    ...
    >
      ...
      <p className={`${styles.paragraph} max-w-[650px] mt-5`}>
        Our team ensures that there is no more end to hackathons, meetups and
        fun events around you. We allow your college societies to join hands and
        bring out marvels just for you.
      </p>
    </div>
    <div>
