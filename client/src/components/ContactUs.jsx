...
export default function ContactUs() {
  return (
      <div className="max-w-6xl mx-auto sm:px-6 lg:px-8 my-14">
            ...
            <form className="p-6 flex flex-col justify-center">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="w-100 mt-2 py-3 px-3 rounded-lg bg-gray-800 border border-gray-700 text-white font-semibold focus:border-indigo-500 focus:outline-none"
                />
              </div>
              ...
              <button
                type="submit"
                className="md:w-32 bg-blue-600 text-white font-bold py-3 px-6 rounded-lg mt-3  transition ease-in-out duration-300"
              >
                Submit
              </button>
            </form>
