...
const Login = () => {
 ...
 <div class="font-sans">
            <div class="relative min-h-screen flex flex-col  sm:justify-center items-center bg-primary ">
                <div class="relative sm:max-w-sm w-full my-[-100px]">
                            ...
                            <div class="flex mt-7 justify-center w-full">
                             ...
                             <div class="mt-7">
                                <div class="flex justify-center items-center">
                                    <label class="mr-2" >Are you not Registered?</label>
